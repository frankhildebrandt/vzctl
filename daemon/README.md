...
ihre serialisierten Attachments einen `vz-net`-Neustart nicht überleben. Bleibt
ein Helper hängen, bricht die Installation ab und lässt `vz-net` unangetastet;
