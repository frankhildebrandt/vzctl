...
| P2 — Net + DNS | vmnet, Dual-DNS, Policies | in progress (#31/#32 ✅; next #51) |
...
| [#30](https://github.com/frankhildebrandt/vzctl/issues/30) | vmnet + Routes + Policies | P2 | in progress (#31/#32 ✅; next #51) |
...
| [#51](https://github.com/frankhildebrandt/vzctl/issues/51) | Default-Netzwerk (voller Zugriff) | ← **next network slice** |
| [#33](https://github.com/frankhildebrandt/vzctl/issues/33) | Firewall-Policies | open (nach #51) |
